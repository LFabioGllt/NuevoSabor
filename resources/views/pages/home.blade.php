    ...
    <section>
      <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-center">
          ...
          <p class="fnt-ssp">Somos un equipo apasionado por preservar y compartir las recetas ancestrales que han
...
<section class="container-fluid p-5 h-sctn bg-clr-s d-flex align-items-center">
